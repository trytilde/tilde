...
impl ::connectrpc::Encodable<crate::proto::tilde::management::v1::GetAgentResponse>
for crate::proto::tilde::management::v1::__buffa::view::GetAgentResponseView<'_> {
    fn encode(
        &self,
        codec: ::connectrpc::CodecFormat,
    ) -> ::std::result::Result<::buffa::bytes::Bytes, ::connectrpc::ConnectError> {
...
impl ::connectrpc::Encodable<crate::proto::tilde::management::v1::ListAgentsResponse>
for crate::proto::tilde::management::v1::__buffa::view::ListAgentsResponseView<'_> {
    fn encode(
        &self,
        codec: ::connectrpc::CodecFormat,
    ) -> ::std::result::Result<::buffa::bytes::Bytes, ::connectrpc::ConnectError> {
...
impl ::connectrpc::Encodable<crate::proto::tilde::management::v1::UpdateAgentResponse>
for crate::proto::tilde::management::v1::__buffa::view::UpdateAgentResponseView<'_> {
    fn encode(
        &self,
        codec: ::connectrpc::CodecFormat,
    ) -> ::std::result::Result<::buffa::bytes::Bytes, ::connectrpc::ConnectError> {
...
pub const AGENT_SERVICE_GET_AGENT_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/tilde.management.v1.AgentService/GetAgent",
        ::connectrpc::StreamType::Unary,
    )
...
pub const AGENT_SERVICE_DELETE_AGENT_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/tilde.management.v1.AgentService/DeleteAgent",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::Unknown);
...
pub trait AgentService: Send + Sync + 'static {
    ...
    fn create_agent<'a>(
        ...
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::tilde::management::v1::CreateAgentRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::proto::tilde::management::v1::CreateAgentResponse,
            > + Send + use<'a, Self>,
        >,
    > + Send;
    ...
    fn get_agent<'a>(
        ...
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::tilde::management::v1::GetAgentRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::proto::tilde::management::v1::GetAgentResponse,
            > + Send + use<'a, Self>,
        >,
    > + Send;
    ...
    fn list_agents<'a>(
        ...
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::tilde::management::v1::ListAgentsRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::proto::tilde::management::v1::ListAgentsResponse,
            > + Send + use<'a, Self>,
        >,
    > + Send;
    ...
    fn update_agent<'a>(
        ...
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::tilde::management::v1::UpdateAgentRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
    ...
    fn delete_agent<'a>(
        ...
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::tilde::management::v1::DeleteAgentRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::proto::tilde::management::v1::DeleteAgentResponse,
            > + Send + use<'a, Self>,
        >,
    > + Send;
}
                ...
                "CreateAgent",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ...
                        req: ::buffa::view::OwnedView<
                            crate::proto::tilde::management::v1::__buffa::view::CreateAgentRequestView<
                                'static,
                            >,
                        >,
                        format|
            ...
            .route_view_idempotent(
                ...
                "GetAgent",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ctx,
                        req: ::buffa::view::OwnedView<
                            crate::proto::tilde::management::v1::__buffa::view::GetAgentRequestView<
                                'static,
                            >,
                        >,
                        format|
            ...
            .route_view_idempotent(
                ...
                "ListAgents",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ctx,
                        req: ::buffa::view::OwnedView<
                            crate::proto::tilde::management::v1::__buffa::view::ListAgentsRequestView<
                                'static,
                            >,
                        >,
                        format|
            ...
            .route_view(
                ...
                "UpdateAgent",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ctx,
                        req: ::buffa::view::OwnedView<
                            crate::proto::tilde::management::v1::__buffa::view::UpdateAgentRequestView<
                                'static,
                            >,
                        >,
                        format|
            ...
            .route_view(
                ...
                "DeleteAgent",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |
                        ctx,
                        req: ::buffa::view::OwnedView<
                            crate::proto::tilde::management::v1::__buffa::view::DeleteAgentRequestView<
                                'static,
                            >,
                        >,
                        format|
...
impl<T: AgentService> ::connectrpc::Dispatcher for AgentServiceServer<T> {
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("tilde.management.v1.AgentService/") else {
        ...
        match method {
            "CreateAgent" => {
                ...
                Box::pin(async move {
                    ...
                    let req: crate::proto::tilde::management::v1::__buffa::view::CreateAgentRequestView<
                        '_,
            ...
            "GetAgent" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::proto::tilde::management::v1::GetAgentRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::proto::tilde::management::v1::__buffa::view::GetAgentRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                        ctx.decode_options(),
            ...
            "ListAgents" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::proto::tilde::management::v1::ListAgentsRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::proto::tilde::management::v1::__buffa::view::ListAgentsRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                        ctx.decode_options(),
            ...
            "UpdateAgent" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::proto::tilde::management::v1::UpdateAgentRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::proto::tilde::management::v1::__buffa::view::UpdateAgentRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                        ctx.decode_options(),
            ...
            "DeleteAgent" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::proto::tilde::management::v1::DeleteAgentRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::proto::tilde::management::v1::__buffa::view::DeleteAgentRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                        ctx.decode_options(),
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    pub async fn create_agent(
        &self,
        request: crate::proto::tilde::management::v1::CreateAgentRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::tilde::management::v1::__buffa::view::CreateAgentResponseView<
                    'static,
                >,
            >,
        >,
    ...
    /// Call the GetAgent RPC. Sends a request to /tilde.management.v1.AgentService/GetAgent.
    pub async fn get_agent(
        &self,
        request: crate::proto::tilde::management::v1::GetAgentRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::tilde::management::v1::__buffa::view::GetAgentResponseView<
                    'static,
                >,
            >,
        >,
    ...
    /// Call the ListAgents RPC. Sends a request to /tilde.management.v1.AgentService/ListAgents.
    pub async fn list_agents(
        &self,
        request: crate::proto::tilde::management::v1::ListAgentsRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::tilde::management::v1::__buffa::view::ListAgentsResponseView<
                    'static,
                >,
            >,
        >,
    ...
    /// Call the UpdateAgent RPC. Sends a request to /tilde.management.v1.AgentService/UpdateAgent.
    pub async fn update_agent(
        &self,
        request: crate::proto::tilde::management::v1::UpdateAgentRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::tilde::management::v1::__buffa::view::UpdateAgentResponseView<
                    'static,
                >,
            >,
        >,
    ...
    /// Call the DeleteAgent RPC. Sends a request to /tilde.management.v1.AgentService/DeleteAgent.
    pub async fn delete_agent(
        &self,
        request: crate::proto::tilde::management::v1::DeleteAgentRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::tilde::management::v1::__buffa::view::DeleteAgentResponseView<
                    'static,
                >,
            >,
        >,
